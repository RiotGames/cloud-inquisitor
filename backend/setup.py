...
setuptools.setup(
    ...
    install_requires=[
        ...
        'cinq-auditor-iam~=2.0.0',
        'cinq-auditor-required-tags~=2.0.0',
        'cinq-auditor-vpc-flowlogs~=2.0.0',
        'cinq-auth-local~=2.0.0',
        'cinq-auth-onelogin-saml~=2.0.0',
        'cinq-collector-aws~=2.0.0',
        'cinq-collector-dns~=2.0.0',
        'cinq-scheduler-sqs~=2.0.0',
        'cinq-scheduler-standalone~=2.0.0',
        'click~=6.7',
        'enum34~=1.1',
